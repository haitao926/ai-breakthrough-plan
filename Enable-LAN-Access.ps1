...
Remove-NetFirewallRule -DisplayName "AI万花筒服务器" -ErrorAction SilentlyContinue
New-NetFirewallRule -DisplayName "AI万花筒服务器" -Direction Inbound -Protocol TCP -LocalPort 8080 -Action Allow | Out-Null
